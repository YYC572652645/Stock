...
const static QString PUTDOWN         = "border-image: url(:/image/image/putdown.png);color:white;";
const static QString PUTON           = "border-image: url(:/image/image/puton.png);color:black;";
