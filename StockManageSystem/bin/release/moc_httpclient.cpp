...
QT_MOC_LITERAL(1, 11, 20), // "downLoadFinishSignal"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 13), // "replyFinished"
QT_MOC_LITERAL(4, 47, 13), // "httpReadyRead"
QT_MOC_LITERAL(5, 61, 18) // "downLoadFinishSlot"

    },
    "HttpClient\0downLoadFinishSignal\0\0"
    "replyFinished\0httpReadyRead\0"
    "downLoadFinishSlot"
};
...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->downLoadFinishSignal(); break;
        case 1: _t->replyFinished(); break;
        case 2: _t->httpReadyRead(); break;
        case 3: _t->downLoadFinishSlot(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpClient::downLoadFinishSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HttpClient::downLoadFinishSignal()
{
